...
partes = [
    ...
    u'<link rel="stylesheet" crossorigin="anonymous" href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Nunito:ital,wght@0,400;0,700;0,900;1,400&family=Rye&display=swap">',
    u'<style>\n' + css + u'\n</style>',
    u'</head>',
    u'<body>',
